...
class Ui_MainWindow(object):
    """Generated using PyQT5 UI code generator. Contains app's static UI"""
    ...
    def setupUi(self, MainWindow):
        ...
        self.layaway_grid = QtWidgets.QGridLayout(self.layaway_page)
        self.layaway_grid.setObjectName("layaway_grid")
        self.layaway_horizontal_layout = QtWidgets.QHBoxLayout()
        self.layaway_horizontal_layout.setObjectName("layaway_horizontal_layout")

        # Layaway Table 1 - layaway id/customer id/name/start
        self.layaway_table_1 = QtWidgets.QTableWidget(self.layaway_page)
        self.layaway_table_1.setMaximumSize(QtCore.QSize(241, 191))
        ...
        self.layaway_horizontal_layout.addWidget(self.layaway_table_2)
        self.layaway_grid.addLayout(self.layaway_horizontal_layout, 0, 0, 1, 1)

        self.layaway_horizontal_layout_2 = QtWidgets.QHBoxLayout()
        self.layaway_horizontal_layout_2.setObjectName("layaway_horizontal_layout_2")
        self.layaway_vertical_layout = QtWidgets.QVBoxLayout()
        self.layaway_vertical_layout.setObjectName("layaway_vertical_layout")
        ...
        self.layaway_text_browser_3 = QtWidgets.QTextBrowser(self.layaway_page)
        self.layaway_text_browser_3.setObjectName("layaway_text_browser_1_3")
        self.layaway_vertical_layout_2.addWidget(self.layaway_text_browser_3)
        self.layaway_horizontal_layout_2.addLayout(self.layaway_vertical_layout_2)
        self.layaway_grid.addLayout(self.layaway_horizontal_layout_2, 1, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Values"))
        self.layaway_label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Initial Notes</span></p></body></html>"))
        self.layaway_label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Notes</span></p></body></html>"))
        self.layaway_label_3.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Transaction History</span></p></body></html>"))
